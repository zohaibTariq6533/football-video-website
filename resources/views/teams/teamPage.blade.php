...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <!-- Main Form Container -->
        <form action="{{ route('createTeams', ['video_id' => $video_id]) }}" method="POST" id="mainTeamsForm">
            @csrf
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        @if(session('success_team1'))
                            <div class="mb-4 bg-green-50 border border-green-200 rounded-xl p-4 flex items-center space-x-3">
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-blue-700 text-sm">Fill in both team names and add players to each team. When you click "Create Both Teams", both teams will be created simultaneously. You can create teams with different numbers of players.</p>
                </div>
            </div>
        </div>
    </div>
...
function updateCreateButton() {
    ...
    if (team1Name && team2Name) {
        ...
        createBtn.classList.add('hover:from-purple-800', 'hover:to-purple-700', 'transform', 'hover:-translate-y-0.5');
    } else {
        createBtn.disabled = true;
        createBtn.classList.add('opacity-50', 'cursor-not-allowed');
        createBtn.classList.remove('hover:from-purple-800', 'hover:to-purple-700', 'transform', 'hover:-translate-y-0.5');
    }
}
